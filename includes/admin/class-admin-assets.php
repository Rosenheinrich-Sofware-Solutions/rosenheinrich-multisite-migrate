    ...
    public static function enqueue(string $hook, bool $is_network): void
    {
        ...
        $localize = array(
            ...
            'i18n'            => array(
                ...
                'serverError500'      => __('Server error (HTTP 500). Check your PHP memory limit and max_execution_time settings, or contact your hosting provider.', 'rosenheinrich-multisite-migrate'),
                'badGateway502'       => __('Bad gateway (HTTP 502). Your server or proxy closed the connection prematurely. Try a smaller chunk size or contact your hosting provider.', 'rosenheinrich-multisite-migrate'),
                'gatewayTimeout504'   => __('Gateway timeout (HTTP 504). The server took too long to respond. Increase your PHP max_execution_time or contact your hosting provider.', 'rosenheinrich-multisite-migrate'),
                'requestTooLarge413'  => __('Request too large (HTTP 413). Your server rejected the upload. Try a smaller file or increase your server upload_max_filesize.', 'rosenheinrich-multisite-migrate'),
